...
This is mean to assess the performance of the two implementation of the main code in my package. User of this package should prefer **crunBMLGrid()**.
**crunBMLGrid()** calls C routines and it is offering the same functionality with **runBMLGrid()**.
The **runBMLGrid()** is implemented using only R and thus slower.
